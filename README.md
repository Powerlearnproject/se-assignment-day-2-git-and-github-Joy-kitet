...
1. Repositories:A repository is a storage space where all the files and their change history are kept.
2. Commits: A commit is a snapshot of the project at a particular point in time.
